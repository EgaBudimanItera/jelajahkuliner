          ...
          <div class="card mb-3">
			...
			<form action="<?php echo base_url()."admin/proses_ubah_kategori";?>" method="post" enctype="multipart/form-data">
			  ...
			  <div class="form-group row">
				...
				<div class="col-sm-5">
				  <textarea class="form-control" id="deskripsi" name="deskripsi"><?=$list->deskripsi_kategori?></textarea>
				</div>
			  </div>
			  <div class="form-group row">
				<label for="foto" class="col-sm-2 col-form-label">Gambar Kategori Awal</label>
				<div class="col-sm-3">
				  <img src="<?=base_url()?>assets/images/<?=$list->foto_kategori?>" height="150" width="300"> 
				</div>
			  </div>
			  <div class="form-group row">
