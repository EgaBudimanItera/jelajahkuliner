...
<html lang="en">
  ...
  <head>
    ...
    <title>Jelajah Kuliner Admin</title>
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
      ...
      <a class="navbar-brand mr-1" href="#">Jelajah Kuliner Admin</a>
    ...
    <div id="wrapper">
      ...
      <ul class="sidebar navbar-nav">
        <li class="nav-item">
          <a class="nav-link" href="<?php echo base_url()."admin/kuliner";?>">
            <i class="fas fa-fw fa-list-ul"></i>
            <span>Lokasi Kuliner</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="<?php echo base_url()."admin/kategori";?>">
            <i class="fas fa-fw fa-folder"></i>
            <span>Kategori Kuliner</span></a>
        </li>
        <li class="nav-item">
